...
<body>
  ...
  <section class="hero">
    ...
    <p class="hero-sub">Fragrance is the only luxury you wear invisibly. VauLT exists to ensure what you carry on your
      skin is worth remembering.</p>
  </section>
  ...
  <div class="container">
    ...
    <div class="manifesto">
      <div class="manifesto-text">
        ...
        <p>VauLT was founded on the belief that fragrance is the most intimate form of self-expression — and the most
          neglected. The market is saturated with celebrity launches and synthetic shortcuts. We built something
          different.</p>
        <p>Every fragrance in our collection is built around single-origin raw materials: Bulgarian rose harvested at
          dawn, Hindi oud aged for decades, Calabrian bergamot pressed same-day. We don't dilute. We don't rush
          maceration.</p>
        <p>When you wear VauLT, you are not wearing a trend. You are wearing a composition that took years to perfect
          and will outlast every season that follows.</p>
      </div>
    ...
    <div class="pillars">
      <div class="pillar">
        ...
        <p class="pillar-desc">We source only single-origin naturals from named growers and distillers. No synthetic
          replacements for costly materials. Every note in every formula is exactly what we say it is.</p>
      </div>
      <div class="pillar">
        <div class="pillar-icon">◇</div>
        <div class="pillar-title">The Nose's Art</div>
        <p class="pillar-desc">Each composition is the work of an independent perfumer — not a committee, not a brief,
          not a focus group. We give our creators full creative authority and credit them by name.</p>
      </div>
      <div class="pillar">
        <div class="pillar-icon">○</div>
        <div class="pillar-title">No Dilution</div>
        <p class="pillar-desc">Our Eau de Parfum concentrations start at 20%. We don't cut with fillers to widen
          margins. Longer maceration, higher concentration — your fragrance opens differently on hour one versus hour
          six.</p>
      </div>
    </div>
    ...
    <div class="security-section">
      <div class="security-grid">
        <div class="security-text">
          ...
          <p>VauLT was built as a demonstration of secure e-commerce architecture. Every transaction flows through a
            stack designed around one principle: your data never touches our server unprotected.</p>
          <div class="thesis-meta">
            <div class="thesis-meta-intro">
              <div>Crafted by Daniel Njama</div>
              A Bachelor&rsquo;s thesis exploring secure web payment systems, built with industry-grade security
              practices for the <strong>Computer Science</strong> programme at <strong>The John Paul II Catholic
                University of Lublin</strong>.
            </div>
        ...
        <div class="security-badges">
          ...
          <div class="security-badge-row">
            ...
            <div class="security-badge-text">
              ...
              <p>Our checkout flow is designed to meet PCI DSS SAQ-A requirements by delegating card handling entirely
                to Stripe.</p>
            </div>
          </div>
        </div>

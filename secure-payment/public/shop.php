...
<body>
        ...
        <div class="product-card" data-category="<?= htmlspecialchars(strtolower($p['category'])) ?>">
          ...
          <div class="product-info">
            ...
            <div class="product-footer">
              ...
              <button class="add-btn" id="btn-<?= htmlspecialchars($p['id']) ?>"
                onclick="addToCart('<?= htmlspecialchars($p['id']) ?>', '<?= htmlspecialchars(addslashes($p['name'])) ?>', <?= (float) $p['price'] ?>, '<?= htmlspecialchars(addslashes($p['category'])) ?>', '<?= htmlspecialchars($p['image']) ?>')">Add</button>
            </div>
          </div>
        </div>
      <?php } ?>
  ...
  <!-- OVERLAY -->
  <button class="overlay" id="overlay" onclick="closeCart()" onkeydown="if(event.key==='Escape')closeCart()"
